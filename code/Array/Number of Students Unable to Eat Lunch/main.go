...
// Submission 	: https://leetcode.com/problems/number-of-students-unable-to-eat-lunch/submissions/872702825/
...
func countStudents(students []int, sandwiches []int) int {
	...
	for true {
		...
		if students[0] == sandwiches[0] {
			students = RemoveFirst(students)
			sandwiches = RemoveFirst(sandwiches)
		} else {
			oldArr := students
			pop := students[0]
			students = RemoveFirst(students)
			students = append(students, pop)
			if IsSame(oldArr, students) {
				break
			}
		}
	}
